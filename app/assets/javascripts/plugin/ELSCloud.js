 ...
 */
ELSCloud.ELS_SetClientSecret = function(clientID, clientSecret)
{
	var ELS_SetClientSecret = ELSPlugin().ELS_Cloud_SetClientSecret(clientID, clientSecret);
	if(ELSCloud.DebugLog)
	{
		console.log("ELSCloud.ELS_SetClientSecret("+clientID+","+clientSecret+")");
		console.log(ELS_SetClientSecret);		
	}
    return ELS_SetClientSecret;
};
